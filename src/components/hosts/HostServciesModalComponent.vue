  ...
  <TransitionRoot as="template" :show="open">
    <Dialog as="div" class="fixed z-10 inset-0 overflow-y-auto" @close="open = false">
      ...
      >
        ...
        >
          <div
            class="inline-block w-full align-bottom bg-white rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-sm sm:w-full sm:p-6"
          >
            <div>
              <div
...
function getHostServices(hostId) {
  DatabaseDataService.getHostServices(hostId)
    .then((res) => {
      ...
      console.log(hostServices.value);
      console.log(hostServices.value.length);
    })
    .catch((err) => {
      console.log(err);
    });
