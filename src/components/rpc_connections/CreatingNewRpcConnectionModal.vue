                ...
                <div class="pt-8">
                  <div>
                    ...
                    <p class="mt-1 text-sm text-gray-500">
                      Fill in a new RPC connection settings
                    </p>
                  </div>
...
async function createNewRpcConnection(connectionSettings) {
  MsfRpcServerConnectionService.createNewConnection(connectionSettings)
    .then((res) => {
      console.log(res.data);
      if (res.status === 201) {
        emit("refreshRpcConnectionsTable");
        ToastService.showToast("New RPC connection was created successfully");
        toggleModal();
      }
    })
