    ...
    <DisclosurePanel class="md:hidden">
      ...
      <div class="pt-4 pb-3 border-t border-gray-700">
        <div class="flex items-center px-5">
          <div class="flex-shrink-0">
            <img class="h-10 w-10 rounded-full" src="../assets/anonymous.png" alt="" />
          </div>
          <div class="ml-3">
...
const user = {
  name: "Anonymous",
  email: "anonymous@collective.com",
...
const navigation = [
  ...
  { name: "Payload generator", href: "/payload-generator", current: false },
];
