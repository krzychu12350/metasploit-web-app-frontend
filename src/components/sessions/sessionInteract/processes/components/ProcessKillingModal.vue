...
async function requestKillingProcess(processPid) {
  SessionDataService.meterpreterWrite({
    session_id: currentSessionId.value,
    ps: MeterpreterCommands.SystemCommands.KILL + " " + processPid,
  })
    .then((res) => {
...
async function getKillingProcessResult(loader) {
  SessionDataService.meterpreterRead({
    ...
    .then((res) => {
      ...
      ToastService.showToast("Process killed");
      loader.hide();
    })
    .catch((err) => {
      loader.hide();
